# Finanzordnung der Studierendenschaft der Hochschule Niederrhein

> **Gesamttext – bitte hier nicht bearbeiten.** Diese Datei wird automatisch aus den Einzelparagraphen in [`finanzordnung/`](finanzordnung/aufbau.md) erzeugt. Änderungen gehören in die jeweilige Paragraphen-Datei dort.
...
2) <a id="p1-2"></a>Sie ergänzt die zwingenden Vorgaben der Haushalts- und Wirtschaftsführungs-Verordnung der Studierendenschaften NRW (HWVO NRW) sowie des Hochschulgesetzes NRW (HG NRW).
...
2) <a id="p2-2"></a>Die Gelder der Studierendenschaft sind öffentliche Mittel. Sie dürfen ausschließlich zur Erfüllung der gesetzlichen und satzungsgemäßen Aufgaben der Studierendenschaft verwendet werden.

3) <a id="p2-3"></a>Verletzt ein Mitglied eines Organs der Studierendenschaft oder einer Fachschaft vorsätzlich oder grob fahrlässig die ihm nach dieser Ordnung obliegenden Pflichten, so hat es der Studierendenschaft den daraus entstandenen Schaden zu ersetzen (Haftung).

## Teil 2 Der Haushaltsplan
...
2) <a id="p4-2"></a>Der Entwurf des Haushaltsplans wird vom Allgemeinen Studierendenausschuss (AStA), federführend durch das Finanzreferat, aufgestellt.

3) <a id="p4-3"></a>Der Haushaltsplan besteht aus Einnahme- und Ausgabetiteln mit jeweils fester Zweckbestimmung. Einnahmen und Ausgaben sind in voller voraussichtlicher Höhe und getrennt voneinander zu veranschlagen.

4) <a id="p4-4"></a>Der Haushaltsplan muss in Einnahmen und Ausgaben ausgeglichen sein.
...
3) <a id="p5-3"></a>Der beschlossene Haushaltsplan ist unverzüglich dem Präsidium der Hochschule Niederrhein vorzulegen und hochschulöffentlich bekannt zu machen.
...
2) <a id="p6-2"></a>Hält das Finanzreferat durch die Auswirkungen eines Beschlusses des AStA oder des StuPa die finanziellen Interessen der Studierendenschaft für gefährdet, so kann es verlangen, dass das Gremium erneut über die Angelegenheit an einem anderen Sitzungstag berät (aufschiebendes Veto).
...
3) <a id="p7-3"></a>Die Feststellung der sachlichen Richtigkeit obliegt dem Finanzreferat. Die Feststellung der rechnerischen Richtigkeit muss zwingend durch eine andere Person (z.B. ein anderes AStA-Mitglied oder die Kassenverwaltung) erfolgen. Beide Personen unterzeichnen die Kassenanordnung.
...
2) <a id="p9-2"></a>Die Rücklagen sind gegen Missbrauch gesichert und verzinslich bei Kreditinstituten anzulegen.

## Teil 4 Kassenwesen und Zahlungsverkehr
...
2) <a id="p10-2"></a>Die Kassenverwaltung regelt den Zahlungsverkehr und verwaltet die Konten. Die Kassenverwaltung darf nicht zugleich die Person sein, die Kassenanordnungen unterzeichnet (strenge Trennung von Anordnung und Ausführung).
...
2) <a id="p11-2"></a>Über die Konten darf die Kassenverwaltung nur gemeinsam mit einer oder einem weiteren Unterschriftsberechtigten (z.B dem AStA-Vorsitz) verfügen (Zwei-Unterschriften-Prinzip).

3) <a id="p11-3"></a>Unterschriftsberechtigte Personen sind unmittelbar nach Ernennung durch den AStA dem Haushaltsausschussvorsitz schriftlich bekannt zu geben

## Teil 5 Verwendung der Mittel
...
2) <a id="p12-2"></a>Die Höhe der Aufwandsentschädigung für Referatsbesetzungen beträgt maximal 560€

3) <a id="p12-3"></a>Die Höhe der Aufwandsentschädigung für den AStA-Vorstand beträgt maximal 1200€
...
2) <a id="p13-2"></a>Bewirtungskosten (z.B. bei Veranstaltungen) sind nur erstattungsfähig, wenn sie im unmittelbaren Zusammenhang mit der Erfüllung gesetzlicher Aufgaben der Studierendenschaft stehen und vorher genehmigt wurden. Es ist eine Liste der bewirteten Personen beizufügen.

## Teil 6 Fachschaften und Initiativen
...
2) <a id="p14-2"></a>Vom Haushaltsansatz für Fachschaften erhält jede Fachschaft einen Sockelbetrag von 1.000 €. Der verbleibende Restbetrag des Ansatzes wird proportional zur Anzahl der ordentlichen Studierenden auf die Fachschaften aufgeteilt.

3) <a id="p14-3"></a>Die Berechnung dieser Summe wird den Fachschaften Transparent vom Finanzreferat übermittelt.

4) <a id="p14-4"></a>Den Fachschaften werden diese Gelder als Selbstbewirtschaftungsmittel zur eigenverantwortlichen Erfüllung ihrer Aufgaben zugewiesen.
...
## Teil 7 Jahresabschluss und Rechnungsprüfung
...
3) <a id="p17-3"></a>Nach Aufstellung des Jahresabschlusses führen die Kassenprüfer\*innenund die Jahresabschlussprüfung durch. Sie erstellen einen schriftlichen Prüfbericht.
...
2) <a id="p19-2"></a>Diese Finanzordnung tritt am Tag nach ihrer Veröffentlichung in den Amtlichen Bekanntmachungen der Hochschule Niederrhein in Kraft.
