# Technik: Aufbau, Nummerierung und Verweise

Wie dieses Repo technisch funktioniert: Einzelparagraphen und Gesamttext,
automatische Nummerierung, Anker, Verweise und deren Prüfung. Zum Mitmachen
reicht meist die [CONTRIBUTING.md](CONTRIBUTING.md); wie der Text selbst
geschrieben wird, steht in [FORMATIERUNG.md](FORMATIERUNG.md).
...
Verweise auf **Absätze** („Absatz 2“) und Verweise, die nur als **Text im
...
angepasst. **Nicht** angepasst werden Verweise auf Absätze („§ 5 Absatz 2“) und
...
| **Hinweis** | Absatz-ID passt nicht zum Paragraphen; ein Verweis im Fließtext („§ 5 Absatz 2“) meint eine Nummer, die sich verschoben hat; ein nicht verlinkter Anker ist verschwunden | nur Information |
...
(`[§ 10 Absatz 4](../satzung/satzung-der-studierendenschaft.md#p10-4)`), nicht
